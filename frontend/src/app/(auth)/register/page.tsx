  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex overflow-hidden font-sans selection:bg-violet-500/30 selection:text-violet-200">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-30 z-0">
        <div className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] rounded-full bg-violet-600 blur-[150px]" />
        <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] rounded-full bg-fuchsia-600 blur-[150px]" />
      </div>
      ...
      <div className="relative flex w-full flex-col justify-center items-center lg:w-1/2 z-10 p-6">
        ...
        <div className="w-full max-w-md px-6">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-extrabold tracking-tight text-slate-100 mb-2">Create Account</h1>
            <p className="text-slate-400 text-sm">Join PulseBoard and start monitoring today</p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-slate-900/60 backdrop-blur-xl shadow-2xl shadow-violet-950/20 p-8 relative overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2.5">
                <label htmlFor="reg-name" className="text-xs font-bold uppercase tracking-wider text-slate-400">
                  Full Name
                </label>
                <Input
                  id="reg-name"
              ...
              <div className="space-y-2.5">
                <label htmlFor="reg-email" className="text-xs font-bold uppercase tracking-wider text-slate-400">
                  Email Address
                </label>
                <Input
                  id="reg-email"
              ...
              <div className="space-y-2.5">
                <label htmlFor="reg-password" className="text-xs font-bold uppercase tracking-wider text-slate-400">
                  Password
                </label>
                <Input
                  id="reg-password"
              ...
              <div className="space-y-2.5">
                <label htmlFor="reg-confirm" className="text-xs font-bold uppercase tracking-wider text-slate-400">
                  Confirm Password
                </label>
                <Input
                  id="reg-confirm"
                  ...
                  type="password"
                  className={cn(
                    "h-12 bg-black/40 border-white/10 focus-visible:ring-violet-500/50 placeholder:text-slate-600 rounded-xl px-4",
                ...
                {confirmPassword && password !== confirmPassword && (
                  <p className="text-[10px] font-bold uppercase tracking-wider text-red-400 pt-1">Passwords do not match</p>
                )}
              </div>
          ...
          <div className="text-center text-sm text-slate-400 mt-8">
            ...
            <Link href="/login" className="font-bold text-violet-400 hover:text-violet-300 hover:underline transition-colors">
              Sign in
            </Link>
          </div>
        </div>
      ...
      <div className="relative hidden lg:flex w-1/2 flex-col justify-center border-l border-white/5 bg-slate-900/30 p-12 z-10 backdrop-blur-sm">
        ...
        <div className="max-w-md mx-auto space-y-12">
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-200">Instant Setup</h3>
                <p className="text-slate-400 text-sm mt-1">Start monitoring your first URL in under 60 seconds with our streamlined dashboard.</p>
              </div>
            </div>
            
            <div className="flex items-start gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-fuchsia-500/10 text-fuchsia-400 border border-fuchsia-500/20">
                <Cpu className="h-5 w-5" />
              </div>
              <div>
                <h3 className="font-bold text-slate-200">AI Diagnoses</h3>
                <p className="text-slate-400 text-sm mt-1">Automatically pinpoint root causes through Gemini-powered log and commit analysis.</p>
              </div>
            </div>
          </div>

          <div className="rounded-2xl bg-white/5 p-6 border border-white/10 backdrop-blur-sm">
            <div className="flex items-center gap-2 text-violet-400 font-bold mb-2 uppercase tracking-wider text-[10px]">
